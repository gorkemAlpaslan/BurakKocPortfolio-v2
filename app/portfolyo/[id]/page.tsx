...
//   const [framePosition, setFramePosition] = useState(40); // Initial position, can be adjusted
...
//       setIsFrameExpanded(scrollPercentage > 5);
//     };
...
//       <Header />
//       {/* Hero Section */}
//       <section className="pt-32 w-screen min-h-screen pb-2 relative overflow-hidden">
//         <div className="flex inset-0 bg-gradient-to-b from-blue-500/10 via-purple-500/10 to-pink-500/10 opacity-30 dark:opacity-10" />
//         <div className="container mx-auto bg-red-500 max-h-0 gap-4 px-4 relative ">
//           <Link
//             href="/portfolyo"
...
//           <div className="flex min-h-screen flex-col justify-between items-center text-center">
...
//                 isFrameExpanded
//                   ? "max-h-[1000px] aspect-video -translate-y-32 scale-[1.05]"
//                   : "max-h-[600px]"
//               }`}
//             >
//               <div
//                 ref={frameRef}
//                 className={`relative w-full rounded-t-[24px] border-[8px] bg-black dark:bg-[#19191e] border-black dark:border-[#19191e] overflow-y-auto ${
//                   isMobile ? "h-[300px]" : "max-h-[560px]"
//                 }`}
//               >
//                 <Image
